"""
nas4candle.nasapi is a Python package which provides a common interface for the implementation and study of scalable hyperparameter and neural architecture search methods. In this package we provide to the user different modules:
...
"""
from nas4candle.nasapi.__version__ import __version__
name = 'nas4candle.nasapi'
version = __version__