...
from nas4candle.nasapi.evaluator import runner
...
class Evaluator:
    ...
    PYTHON_EXE = os.environ.get('nas4candle.nasapi_PYTHON_BACKEND', sys.executable)
    ...
    def create(run_function, cache_key=None, method='balsam'):
        ...
        if method == "balsam":
            from nas4candle.nasapi.evaluator._balsam import BalsamEvaluator
            Eval = BalsamEvaluator
        elif method == "subprocess":
            from nas4candle.nasapi.evaluator._subprocess import SubprocessEvaluator
            Eval = SubprocessEvaluator
        elif method == "processPool":
            from nas4candle.nasapi.evaluator._processPool import ProcessPoolEvaluator
            Eval = ProcessPoolEvaluator
        else:
            from nas4candle.nasapi.evaluator._threadPool import ThreadPoolEvaluator
