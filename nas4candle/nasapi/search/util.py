...
masterLogger = None
LOG_LEVEL = os.environ.get('nas4candle.nasapi_LOG_LEVEL', 'DEBUG')
...
def conf_logger(name):
    ...
    if (masterLogger == None):
        masterLogger = logging.getLogger('nas4candle.nasapi')

        # handler = logging.FileHandler(f'nas4candle.nasapi-{rank}.log') # debug
        handler = logging.FileHandler('nas4candle.nasapi.log')
