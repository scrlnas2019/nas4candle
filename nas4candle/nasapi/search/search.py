...
class Search:
    ...
    A search comprises 3 main objects: a problem, a run function and an evaluator:
        The `problem` class defines the optimization problem, providing details like the search domain.  (You can find many kind of problems in `nas4candle.nasapi.benchmark`)
    ...
    def _base_parser():
        ...
        parser.add_argument("--problem",
            default="nas4candle.nasapi.benchmark.hps.polynome2.Problem"
        )
        parser.add_argument("--run",
            default="nas4candle.nasapi.benchmark.hps.polynome2.run"
        )
