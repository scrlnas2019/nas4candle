...
from nas4candle.nasapi.search.nas.model.space.node import Node, ConstantNode
from nas4candle.nasapi.search.nas.model.space.op.basic import Connect, Tensor
from nas4candle.nasapi.search.nas.model.space.op.op1d import Concatenate, Identity
