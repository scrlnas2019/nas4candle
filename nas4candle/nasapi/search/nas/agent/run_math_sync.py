...
import nas4candle.nasapi.search.nas.utils.common.tf_util as U
from nas4candle.nasapi.evaluator import Evaluator
from nas4candle.nasapi.search.nas.agent import pposgd_sync_ph
from nas4candle.nasapi.search.nas.agent.policy import lstm_ph
from nas4candle.nasapi.search.nas.env import MathEnv
from nas4candle.nasapi.search.nas.utils import bench, logger
from nas4candle.nasapi.search.nas.utils.common import set_global_seeds
from nas4candle.nasapi.search.nas.agent.utils import reward_for_final_timestep
...
def main():
    from nas4candle.nasapi.search.nas.agent.run_func_math import run_func
