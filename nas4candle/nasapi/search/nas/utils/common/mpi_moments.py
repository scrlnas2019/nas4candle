...
from nas4candle.nasapi.search.nas.utils.common import zipsame
...
def test_runningmeanstd():
    ...
    subprocess.check_call(['mpirun', '-np', '3',
        'python','-c',
        'from  nas4candle.nasapi.search.nas.utils.common.mpi_moments import _helper_runningmeanstd; _helper_runningmeanstd()'])
